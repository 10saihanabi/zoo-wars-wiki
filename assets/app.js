...
<h1>動物園ウォーズ攻略Wiki</h1><p class="lead">『動物園ウォーズ（Zoo Wars）』の非公式攻略Wikiです。カード性能、対人戦の考え方、相性検証、棋譜研究をまとめます。</p>
...
<section id="cards"><h2>カード</h2><p><a href="cards.html"><strong>▶ カード一覧を見る</strong></a></p></section>
<section id="roles"><h2>役割別</h2>${table(['役割','代表例','説明'],roleRows)}</section>
<section id="deck"><h2>デッキ構築</h2><p>6枚それぞれに役割を持たせ、相手の攻めに回答できる形を作ります。</p><p><a href="beginner.html#deck">初心者向けのデッキ構築解説 →</a></p></section>
